			...
			<form action="film/updateFilm.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 80%">
					...
					<div class="formRow">
						<label>导演</label>
						<div class="formRight">
							<input type="text" name="daoyan" class="mws-textinput" id="daoyan" value="${film.daoyan}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
						<label>主演</label>
						<div class="formRight">
							<input type="text" name="zhuyan" class="mws-textinput" id="zhuyan" value="${film.zhuyan}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
						<label>时长</label>
						<div class="formRight">
							<input type="text" name="shichang" class="mws-textinput" id="shichang" value="${film.shichang}" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
